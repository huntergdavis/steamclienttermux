...
| Bionic/system-Vulkan host | The bridge passes persistent frame handoffs, Steam loader selection, real Adreno limits, logical-device/queue creation, and native enablement of an advertised device extension. | Bridge measured Wine/DXVK instance/WSI extensions and device feature chains, reach one real DXVK frame, then run the fixed 2800×1752 Low Tomb Raider A/B. |
