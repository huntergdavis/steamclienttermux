...
| Bionic/system-Vulkan host | Direct Android-loader enumeration, a real glibc-client/Bionic-service handshake, and field-for-field Adreno capability parity now pass in the separate bridge project. | Continue as a separate architecture project. The control plane works, but native-window/surface, object lifetime, shared memory/synchronization, generated Vulkan dispatch, DXVK integration, and a rendered frame remain before any Tomb Raider FPS A/B. |
