...
GAME_PROFILES = {
    ...
    "720p-ultra-no-tessellation": {
        "resolution": "1280x720",
        "graphics": "Ultra without tessellation",
        "registry_profile": "720p-normal",
        "benchmark_preset": "720p-ultra-no-tessellation",
        "quality_level": 3,
        "benchmark_overrides": {"EnableTessellation": 0},
    },
    "1080p-ultra-no-tessellation": {
        "resolution": "1920x1080",
        "graphics": "Ultra without tessellation",
        "registry_profile": "1080p-normal",
        "benchmark_preset": "1080p-ultra-no-tessellation",
        "quality_level": 3,
        "benchmark_overrides": {"EnableTessellation": 0},
    },
    "720p-ultra-no-tessellation-ssao1": {
        "resolution": "1280x720",
        "graphics": "Ultra without tessellation, SSAO mode 1",
        "registry_profile": "720p-normal",
        "benchmark_preset": "720p-ultra-no-tessellation-ssao1",
        "quality_level": 3,
        "benchmark_overrides": {"EnableTessellation": 0, "SSAOMode": 1},
    },
    "1080p-ultra-no-tessellation-ssao1": {
        "resolution": "1920x1080",
        "graphics": "Ultra without tessellation, SSAO mode 1",
        "registry_profile": "1080p-normal",
        "benchmark_preset": "1080p-ultra-no-tessellation-ssao1",
        "quality_level": 3,
        "benchmark_overrides": {"EnableTessellation": 0, "SSAOMode": 1},
    },
    "720p-ultra-no-tessellation-ssao1-dof1": {
        "resolution": "1280x720",
        "graphics": "Ultra without tessellation, SSAO mode 1, DOF quality 1",
        "registry_profile": "720p-normal",
    ...
    "1080p-ultra-no-tessellation-ssao1-dof1": {
        "resolution": "1920x1080",
        "graphics": "Ultra without tessellation, SSAO mode 1, DOF quality 1",
        "registry_profile": "1080p-normal",
        "benchmark_preset": "1080p-ultra-no-tessellation-ssao1-dof1",
        "quality_level": 3,
        "benchmark_overrides": {
            "EnableTessellation": 0,
            "SSAOMode": 1,
...
def validate_benchmark_quality_settings(
    ...
    expected = {
        ...
        "FullscreenRefreshRate": 60,
        "EnableMotionBlur": 0,
        **game_profile.get("benchmark_overrides", {}),
    }
    mismatches = {
